...
client.on('ready', async() => {
 ...
 const number = "+919662705684";

 // Your message.
const text = "Thank you for your recent purchase of the *Biniki* product! 🎉 \n We appreciate your trust in us and hope you are delighted with your new [Product Name]. For more information, tips, and exclusive offers, visit our website: Biniki Website.If you have any questions or need further assistance, please don't hesitate to reach out.Enjoy your Biniki! https://vertumode.kumawat.co.in/product/peplum-bralette-3/";
const url="https://images.pexels.com/photos/6341589/pexels-photo-6341589.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1";
...
client.on('message', async msg => {
    ...
    if (msg.body === '!ping reply') {
        ...
        await chat.sendMessage(`Hi @${userNumber}, @${userNumber}`, {
            mentions: [userNumber, userNumber]
        });
